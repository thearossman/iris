...
pub(crate) struct CallbackGroupSpec {
    pub(crate) filter: String,
    pub(crate) level: Option<StateTransition>,
    pub(crate) name: String,
    pub(crate) expl_parsers: Vec<String>,
}

/// Spec generated by #[callback_fn]
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
...
impl ParsedInput {
    ...
    pub(crate) fn levels(&self) -> Vec<StateTransition> {
        match self {
...
impl InputKeys {
    ...
    fn contains_valid_keys(input: &str) -> bool {
    ...
    fn parse_filters_from_file(filter: &String) -> Result<String> {
        ...
        let expanded = re
            ...
            .to_string();
        println!("Parsed filter from file.");
        Ok(expanded)
    }
    ...
    fn callback(
        args: Option<String>,
        name: &str,
    ) -> Result<(String, Vec<StateTransition>, Vec<String>)> {
